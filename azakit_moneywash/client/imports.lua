...
function TriggerServerCallback(name, cb, ...)
	...
	TriggerServerEvent('azakit_moneywash:triggerServerCallback', name, CurrentRequestId, ...)
...
RegisterNetEvent('azakit_moneywash:serverCallback')
AddEventHandler('azakit_moneywash:serverCallback', function(requestId, ...)
